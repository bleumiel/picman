...
11. `polir-experience-de-scan`
   - Progression de scan visible, picker de dossier natif, miniatures de groupe, pre-affichage des doublons pendant le scan et filtrage par taille en place; prochaine amelioration naturelle: progression de quarantaine, selection fine et eventuelle parallelisation configurable.
